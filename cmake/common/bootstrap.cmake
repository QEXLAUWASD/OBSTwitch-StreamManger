...
# Extract the numeric portion (MAJOR.MINOR.PATCH) for CMake's project(VERSION ...)
# which does not accept non-numeric version strings (e.g. "1.2.0-hotfix")
string(REGEX MATCH "^[0-9]+\\.[0-9]+\\.[0-9]+" _version_numeric "${_version}")
if(NOT _version_numeric)
  set(_version_numeric "${_version}")
endif()

string(REPLACE "." ";" _version_canonical "${_version_numeric}")
